...
with st.sidebar:
    ...
    app_mode = st.radio("Chế độ hiển thị", ["Phân loại giấc ngủ (Người dùng)", "Nghiên cứu & Huấn luyện (Dev)"])
    st.markdown("---")
...
if app_mode == "Nghiên cứu & Huấn luyện (Dev)":
...
# ══════════════════════════════════════════════════════════════════
if app_mode == "Phân loại giấc ngủ (Người dùng)":
    with st.container():
        ...
        with col_inf_l:
            ...
            # ── Architecture params ───────────────────────────────────
            with st.expander("Kiến trúc mô hình (phải khớp checkpoint)", expanded=False):
